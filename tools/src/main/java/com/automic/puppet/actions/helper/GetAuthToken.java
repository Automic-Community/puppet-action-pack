...
public class GetAuthToken {
	...
	public static String restResponse (WebResource webresource, String username, String password, String apiVersion) throws AutomicException {
		...
		response = webres.accept(MediaType.APPLICATION_JSON).entity(getJsonAuthentication(username, password), MediaType.APPLICATION_JSON).post(ClientResponse.class);
